                        ...
                        <>
                            ...
                            <div className="w-1/3 border-r border-slate-800 bg-slate-950/30 overflow-y-auto">
                                <div className="p-3 space-y-2">
                                    <button
                                        onClick={handleNew}
                                        className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-left text-blue-400 hover:bg-blue-400/10 border border-blue-500/20 transition-all"
                                    >
                                    ...
                                    <div className="pt-2">
                                        ...
                                        {savedConnections.length === 0 ? (
                                            ...
                                            savedConnections.map(conn => (
                                                <div
                                                    key={conn.id}
                                                    className="group flex items-center justify-between px-3 py-2 rounded-lg cursor-pointer transition-all mb-1 hover:bg-slate-800/40 text-slate-400 hover:text-slate-100"
                            ...
                            <div className="flex-1 flex flex-col items-center justify-center p-8 bg-slate-900/20 text-center space-y-4">
                                <div className="text-4xl">🎛️</div>
                                <div className="space-y-1">
                                    <h3 className="text-slate-300 font-medium">Profile Management</h3>
                                    <p className="text-slate-500 text-sm max-w-xs">Select a profile from the left to edit, or create a new one to get started.</p>
                                </div>
                            </div>
                        </>
                    ) : (
