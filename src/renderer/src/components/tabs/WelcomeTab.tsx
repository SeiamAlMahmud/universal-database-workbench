...
const WelcomeTab: React.FC = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center flex-1 bg-slate-900 text-slate-300 select-none">
            {/* Hero */}
            <div className="flex flex-col items-center gap-4 mb-12">
                ...
                <div className="text-center">
                    <h1 className="text-2xl font-bold text-slate-100 mb-1">DB Workbench</h1>
            ...
            <div className="grid grid-cols-2 gap-3 w-full max-w-sm mb-8">
                ...
                >
                    ...
                    <div>
                        <p className="text-sm font-semibold text-slate-200">New Query</p>
                        <p className="text-xs text-slate-500 mt-0.5">Open a SQL editor</p>
                    </div>
                </button>
                ...
                >
                    ...
                    <div>
                        <p className="text-sm font-semibold text-slate-200">Add Connection</p>
                        <p className="text-xs text-slate-500 mt-0.5">Connect to database</p>
                    </div>
                </button>
            </div>
